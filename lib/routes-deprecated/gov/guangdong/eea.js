...
module.exports = async (ctx) => {
    ...
    if (!cfg) {
        throw new Error('Bad category. See <a href="https://docs-rss.windego.cn/routes/government#guang-dong-sheng-ren-min-zheng-fu-guang-dong-sheng-jiao-yu-kao-shi-yuan">docs</a>');
    }
