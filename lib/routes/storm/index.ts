...
export const route: Route = {
  ...
  :::tip
  支持形如 \`https://www.storm.mg/category/118\` 的路由，即 [\`/storm/category/118\`](https://rss.windego.cn/storm/category/118)

  支持形如 \`https://www.storm.mg/localarticle-category/s149845\` 的路由，即 [\`/storm/localarticle-category/s149845\`](https://rss.windego.cn/storm/localarticle-category/s149845)
  :::`,
};
