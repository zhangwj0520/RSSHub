...
export const route: Route = {
    ...
    handler,
    url: 'logonews.cn/',
    description: `如 [中国 - 标志情报局](https://www.logonews.cn/tag/china) 的 URL 为 \`https://www.logonews.cn/tag/china\`，可得路由为 [\`/logonews/tag/china\`](https://rss.windego.cn/logonews/tag/china)。`,
};
