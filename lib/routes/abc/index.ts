...
export const route: Route = {
  ...
  For example, the URL for [Computer Science](https://www.abc.net.au/news/topic/computer-science) is \`https://www.abc.net.au/news/topic/computer-science\`, the \`category\` is \`news/topic/computer-science\`, and the \`documentId\` of the Topic is \`2302\`, so the route is [/abc/news/topic/computer-science](https://rss.windego.cn/abc/news/topic/computer-science) and [/abc/2302](https://rss.windego.cn/abc/2302).
