...
export const route: Route = {
  ...
  参数 industry 为 \`互联网行业\` 或 \`1\`，此时路由为 [\`/questmobile/report/互联网行业\`](https://rss.windego.cn/questmobile/report/互联网行业) 或 [\`/questmobile/report/1/-1\`](https://rss.windego.cn/questmobile/report/1/-1)。

  若订阅标签 [榜单](https://www.questmobile.com.cn/research/reports/-1/11)，网址为 \`https://www.questmobile.com.cn/research/reports/-1/11\`
  参数 label 为 \`榜单\` 或 \`11\`，此时路由为 [\`/questmobile/report/榜单\`](https://rss.windego.cn/questmobile/report/榜单) 或 [\`/questmobile/report/-1/11\`](https://rss.windego.cn/questmobile/report/-1/11)。
  ...
  参数 industry 为 \`品牌领域\` 或 \`2\`，参数 label 为 \`互联网经济\` 或 \`1\`，此时路由为 [\`/questmobile/report/品牌领域/互联网经济\`](https://rss.windego.cn/questmobile/report/品牌领域/互联网经济) 或 [\`/questmobile/report/2/1\`](https://rss.windego.cn/questmobile/report/2/1)，甚至 [\`/questmobile/report/品牌领域/1\`](https://rss.windego.cn/questmobile/report/品牌领域/1)。
  :::
