...
export const route: Route = {
    ...
    handler,
    description: `:::tip
-   演出城市 \`cityCode\` 查询: \`/showstart/search/city/:keyword\`, 如: [https://rss.windego.cn/showstart/search/city/杭州](https://rss.windego.cn/showstart/search/city/杭州)

-   演出风格 \`showStyle\` 查询: \`/showstart/search/style/:keyword\`，如: [https://rss.windego.cn/showstart/search/style/摇滚](https://rss.windego.cn/showstart/search/style/摇滚)
:::`,
};
