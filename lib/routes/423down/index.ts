...
export const route: Route = {
    ...
    description: `:::tip
  若订阅 [Android - 423Down](https://www.423down.com/apk)，网址为 \`https://www.423down.com/apk\`。截取 \`https://www.423down.com/\` 到末尾的部分 \`apk\` 作为参数填入，此时路由为 [\`/423down/apk\`](https://rss.windego.cn/423down/apk)。
  :::
  ...
  | [安卓软件](https://www.423down.com/apk) |
  | --------------------------------------- |
  | [apk](https://rss.windego.cn/423down/apk)   |
  ...
  | ----------------------------------------- | --------------------------------------------------- | --------------------------------------------- | ----------------------------------------- | -------------------------------------- |
  | [zd423](https://rss.windego.cn/423down/zd423) | [multimedia](https://rss.windego.cn/423down/multimedia) | [browser](https://rss.windego.cn/423down/browser) | [image](https://rss.windego.cn/423down/image) | [im](https://rss.windego.cn/423down/im)    |
  ...
  | ---------------------------------------- | ---------------------------------------- | ----------------------------------------------- | --------------------------------------------------- | --------------------------------------------------- |
  | [work](https://rss.windego.cn/423down/work)  | [down](https://rss.windego.cn/423down/down)  | [softtool](https://rss.windego.cn/423down/softtool) | [systemsoft](https://rss.windego.cn/423down/systemsoft) | [systemplus](https://rss.windego.cn/423down/systemplus) |

  | [安全软件](https://www.423down.com/security)    | [补丁相关](https://www.423down.com/patch) | [硬件相关](https://www.423down.com/hardware)    |
  | ----------------------------------------------- | ----------------------------------------- | ----------------------------------------------- |
  | [security](https://rss.windego.cn/423down/security) | [patch](https://rss.windego.cn/423down/patch) | [hardware](https://rss.windego.cn/423down/hardware) |
  ...
  | ------------------------------------------- | ------------------------------------------- | ----------------------------------------- | --------------------------------------------------- | ------------------------------------------------- |
  | [win11](https://rss.windego.cn/423down/win11)   | [win10](https://rss.windego.cn/423down/win10)   | [win7](https://rss.windego.cn/423down/win7)   | [win7/winxp](https://rss.windego.cn/423down/win7/winxp) | [pe-system](https://rss.windego.cn/423down/pe-system) |
  `,
