...
async function handler(ctx) {
    ...
    if (cookie === undefined) {
        throw new ConfigNotFoundError('缺少对应 loginUid 的 Bilibili 用户登录后的 Cookie 值 <a href="https://docs-rss.windego.cn/zh/deploy/config#route-specific-configurations">bilibili 用户关注动态系列路由</a>');
    }
