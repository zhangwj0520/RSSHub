...
export const route: Route = {
  ...
  例如：
  [\`/linkedin/cn/jobs/Software?location=shanghai&period=1\`](https://rss.windego.cn/linkedin/cn/jobs/Software?location=shanghai\&period=1): 查找所有在上海的今日发布的所有 Software 工作
