...
export const route: Route = {
  ...
  | :-----------: | :-------------------------: | ---------------------------------------------------------------------------------- |
  |     nature    |            Nature           | [/nature/research/nature](https://rss.windego.cn/nature/research/nature)               |
  |      nbt      |     Nature Biotechnology    | [/nature/research/nbt](https://rss.windego.cn/nature/research/nbt)                     |
  |     neuro     |     Nature Neuroscience     | [/nature/research/neuro](https://rss.windego.cn/nature/research/neuro)                 |
  |       ng      |       Nature Genetics       | [/nature/research/ng](https://rss.windego.cn/nature/research/ng)                       |
  |       ni      |      Nature Immunology      | [/nature/research/ni](https://rss.windego.cn/nature/research/ni)                       |
  |     nmeth     |        Nature Method        | [/nature/research/nmeth](https://rss.windego.cn/nature/research/nmeth)                 |
  |     nchem     |       Nature Chemistry      | [/nature/research/nchem](https://rss.windego.cn/nature/research/nchem)                 |
  |      nmat     |       Nature Materials      | [/nature/research/nmat](https://rss.windego.cn/nature/research/nmat)                   |
  | natmachintell | Nature Machine Intelligence | [/nature/research/natmachintell](https://rss.windego.cn/nature/research/natmachintell) |
