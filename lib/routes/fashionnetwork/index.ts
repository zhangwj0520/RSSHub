...
export const route: Route = {
    ...
    description: `:::tip
  若订阅 [独家新闻](https://fashionnetwork.cn)，网址为 \`https://fashionnetwork.cn/lists/13.html\`。截取 \`https://fashionnetwork.cn/\` 到末尾 \`.html\` 的部分 \`13\` 作为参数填入，此时路由为 [\`/fashionnetwork/cn/lists/13\`](https://rss.windego.cn/fashionnetwork/cn/lists/13)。
  :::

  | 分类                                           | ID                                                  |
  | ---------------------------------------------- | --------------------------------------------------- |
  | [独家](https://fashionnetwork.cn/lists/13)     | [13](https://rss.windego.cn/fashionnetwork/cn/lists/13) |
  | [商业](https://fashionnetwork.cn/lists/1)      | [1](https://rss.windego.cn/fashionnetwork/cn/lists/1)   |
  | [人物](https://fashionnetwork.cn/lists/8)      | [8](https://rss.windego.cn/fashionnetwork/cn/lists/8)   |
  | [设计](https://fashionnetwork.cn/lists/3)      | [3](https://rss.windego.cn/fashionnetwork/cn/lists/3)   |
  | [产业](https://fashionnetwork.cn/lists/5)      | [5](https://rss.windego.cn/fashionnetwork/cn/lists/5)   |
  | [创新研究](https://fashionnetwork.cn/lists/6)  | [6](https://rss.windego.cn/fashionnetwork/cn/lists/6)   |
  | [人事变动](https://fashionnetwork.cn/lists/12) | [12](https://rss.windego.cn/fashionnetwork/cn/lists/12) |
  | [新闻资讯](https://fashionnetwork.cn/lists/11) | [11](https://rss.windego.cn/fashionnetwork/cn/lists/11) |
  `,
